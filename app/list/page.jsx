...
//           <li
//             key={task.id}
//             className="flex justify-between items-center bg-secondary p-2 rounded shadow"
//           >
//             <span>{task.content}</span>
//             <span className="text-sm text-gray-500">[{col.title}]</span>
//           </li>
//         ))
//       )}
//     </ul>
...
//           Switch to {viewMode === 'kanban' ? 'List View' : 'Kanban View'}
//         </Button>
//       </div>
