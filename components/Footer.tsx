...
export default function Footer() {
  ...
  return (
    <footer className="py-10 text-gray-600 font-sans bg-black">
      <div className="max-w-6xl mx-auto px-5">
        <div className="flex flex-wrap mb-8">
          <div className="flex-1 min-w-[200px] mb-5">
            <h3 className="text-lg font-bold mb-4 text-gray-100">About Us</h3>
          ...
          <div className="flex-1 min-w-[200px] mb-5">
            ...
            <ul className="list-none p-0 m-0">
              <li><a href="/" className="text-sm text-gray-100 hover:underline leading-8">Dashboard</a></li>
              <li><a href="/tasks" className="text-sm text-gray-100 hover:underline leading-8">My Tasks</a></li>
              <li><a href="/projects" className="text-sm text-gray-100 hover:underline leading-8">Projects</a></li>
              <li><a href="/team" className="text-sm text-gray-100 hover:underline leading-8">Team</a></li>
            </ul>
          </div>
          <div className="flex-1 min-w-[200px] mb-5">
